public class TenagaDidik extends Karyawan{
    public int waktu;

    public TenagaDidik(int nip, String newName, String newAlamat, String newLahir, String newJensiKelamin, int newTahunMasuk){
